        ...
        <div >
            ...
            <div className={`video-background-container`}>
                <Container xs={12} md={6}> 
                    ...
                    <Col id="about" style={{marginTop:'50px', backgroundColor: 'rgb(245 183 155)'}}>
                    ...
                    <div style={{marginTop:'50px', backgroundColor: 'rgb(245 183 155)'}}>
                        ...
                        <Row>
                            <Col xs={7}><FontAwesomeIcon  beatFade icon={faMinus} />AWS(S3, Lambda, EC2, Step-Functions)</Col>
                            <Col><FontAwesomeIcon  beatFade icon={faMinus} />GraphQL</Col>
                        </Row>
                    </div>
                    
                    
                    <Col id='travel' style={{marginTop:'50px', backgroundColor: 'rgb(245 183 155)'}}>
                        <h3 className='section-style'>Travel Photos</h3>
                        <Carousel interval={null}>
                            <Carousel.Item>
                                <Image  roundedCircle className='carousel-image' src='/denver.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> Denver </p></Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Image  roundedCircle className='carousel-image' src='/denver2.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> Denver </p></Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/denver3.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> Denver </p></Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/DR.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> Dominican Republic </p></Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/DR2.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> Dominican Republic </p></Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/jamaica.JPEG'/>
                            ...
                            <Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/ny.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> New York</p></Carousel.Caption>
                            </Carousel.Item>
                            <Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/ny2.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> New York </p></Carousel.Caption>
                            </Carousel.Item><Carousel.Item>
                                <Image roundedCircle className='carousel-image' src='/ny3.JPEG'/>
                                <Carousel.Caption><p className='carousel-caption-p'> New York </p></Carousel.Caption>
                            </Carousel.Item>
